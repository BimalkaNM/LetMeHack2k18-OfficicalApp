package com.csmprojects.letmehack;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mainDrawer = findViewById(R.id.mainDrawerLayout);
       // mainNavigationView = findViewById(R.id.mainNavigationView);
        mainDrawerToggle  = new ActionBarDrawerToggle(this,mainDrawer,R.string.open,R.string.close);
